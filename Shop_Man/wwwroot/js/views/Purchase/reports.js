    ...
    $.ajax({
        type: "POST",
    url: WEB_URL + "Purchase/GetPurchaseEntryViewModelReport",
    ...
    $(this).attr('href', WEB_URL + 'Purchase/PurchaseReport?fromDate=' + _fromDate + "&&toDate=" + _toDate + "&&customerIDs=" + _custIDs + "&&IsDetails=" + IsDetails + "&&type=" + type);
        });
